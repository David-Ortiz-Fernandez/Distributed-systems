...
#ifndef SOAP_TYPE_conecta4ns__insertChip_DEFINED
#define SOAP_TYPE_conecta4ns__insertChip_DEFINED
SOAP_FMAC3 void SOAP_FMAC4 soap_default_conecta4ns__insertChip(struct soap*, struct conecta4ns__insertChip *);
SOAP_FMAC3 void SOAP_FMAC4 soap_serialize_conecta4ns__insertChip(struct soap*, const struct conecta4ns__insertChip *);
SOAP_FMAC3 int SOAP_FMAC4 soap_out_conecta4ns__insertChip(struct soap*, const char*, int, const struct conecta4ns__insertChip *, const char*);
SOAP_FMAC3 struct conecta4ns__insertChip * SOAP_FMAC4 soap_in_conecta4ns__insertChip(struct soap*, const char*, struct conecta4ns__insertChip *, const char*);

SOAP_FMAC3 struct conecta4ns__insertChip * SOAP_FMAC4 soap_new_conecta4ns__insertChip(struct soap *soap, int n);
SOAP_FMAC3 int SOAP_FMAC4 soap_put_conecta4ns__insertChip(struct soap*, const struct conecta4ns__insertChip *, const char*, const char*);

#ifndef soap_write_conecta4ns__insertChip
#define soap_write_conecta4ns__insertChip(soap, data) ( soap_free_temp(soap), soap_begin_send(soap) || (soap_serialize_conecta4ns__insertChip(soap, data), 0) || soap_put_conecta4ns__insertChip(soap, data, "conecta4ns:insertChip", "") || soap_end_send(soap), (soap)->error )
#endif

SOAP_FMAC3 struct conecta4ns__insertChip * SOAP_FMAC4 soap_get_conecta4ns__insertChip(struct soap*, struct conecta4ns__insertChip *, const char*, const char*);

#ifndef soap_read_conecta4ns__insertChip
#define soap_read_conecta4ns__insertChip(soap, data) ( ((data) ? (soap_default_conecta4ns__insertChip(soap, (data)), 0) : 0) || soap_begin_recv(soap) || !soap_get_conecta4ns__insertChip(soap, (data), NULL, NULL) || soap_end_recv(soap), (soap)->error )
#endif

#endif

#ifndef SOAP_TYPE_conecta4ns__insertChipResponse_DEFINED
#define SOAP_TYPE_conecta4ns__insertChipResponse_DEFINED
SOAP_FMAC3 void SOAP_FMAC4 soap_default_conecta4ns__insertChipResponse(struct soap*, struct conecta4ns__insertChipResponse *);
SOAP_FMAC3 void SOAP_FMAC4 soap_serialize_conecta4ns__insertChipResponse(struct soap*, const struct conecta4ns__insertChipResponse *);
SOAP_FMAC3 int SOAP_FMAC4 soap_out_conecta4ns__insertChipResponse(struct soap*, const char*, int, const struct conecta4ns__insertChipResponse *, const char*);
SOAP_FMAC3 struct conecta4ns__insertChipResponse * SOAP_FMAC4 soap_in_conecta4ns__insertChipResponse(struct soap*, const char*, struct conecta4ns__insertChipResponse *, const char*);
...
SOAP_FMAC3 int SOAP_FMAC4 soap_put_conecta4ns__insertChipResponse(struct soap*, const struct conecta4ns__insertChipResponse *, const char*, const char*);

#ifndef soap_write_conecta4ns__insertChipResponse
#define soap_write_conecta4ns__insertChipResponse(soap, data) ( soap_free_temp(soap), soap_begin_send(soap) || (soap_serialize_conecta4ns__insertChipResponse(soap, data), 0) || soap_put_conecta4ns__insertChipResponse(soap, data, "conecta4ns:insertChipResponse", "") || soap_end_send(soap), (soap)->error )
#endif

SOAP_FMAC3 struct conecta4ns__insertChipResponse * SOAP_FMAC4 soap_get_conecta4ns__insertChipResponse(struct soap*, struct conecta4ns__insertChipResponse *, const char*, const char*);

#ifndef soap_read_conecta4ns__insertChipResponse
#define soap_read_conecta4ns__insertChipResponse(soap, data) ( ((data) ? (soap_default_conecta4ns__insertChipResponse(soap, (data)), 0) : 0) || soap_begin_recv(soap) || !soap_get_conecta4ns__insertChipResponse(soap, (data), NULL, NULL) || soap_end_recv(soap), (soap)->error )
#endif
