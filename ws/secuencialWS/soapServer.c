...
SOAP_SOURCE_STAMP("@(#) soapServer.c ver 2.8.35 2016-11-29 09:10:30 GMT")
...
SOAP_FMAC5 int SOAP_FMAC6 soap_serve_request(struct soap *soap)
{
	...
	if (!soap_match_tag(soap, soap->tag, "conecta4ns:insertChip"))
		return soap_serve_conecta4ns__insertChip(soap);
...
{	struct conecta4ns__getStatus soap_tmp_conecta4ns__getStatus;
	...
	if (soap_body_end_in(soap)
	 ...
	 || soap_end_recv(soap))
		return soap->error;
	soap->error = conecta4ns__getStatus(soap, soap_tmp_conecta4ns__getStatus.playerName, soap_tmp_conecta4ns__getStatusResponse.status);
	if (soap->error)
		return soap->error;
	soap->encodingStyle = "";
	soap_serializeheader(soap);
...
SOAP_FMAC5 int SOAP_FMAC6 soap_serve_conecta4ns__insertChip(struct soap *soap)
{	struct conecta4ns__insertChip soap_tmp_conecta4ns__insertChip;
	...
	struct tBlock soap_tmp_conecta4ns__tBlock;
	soap_default_conecta4ns__insertChipResponse(soap, &soap_tmp_conecta4ns__insertChipResponse);
	soap_default_conecta4ns__tBlock(soap, &soap_tmp_conecta4ns__tBlock);
	soap_tmp_conecta4ns__insertChipResponse.status = &soap_tmp_conecta4ns__tBlock;
	soap_default_conecta4ns__insertChip(soap, &soap_tmp_conecta4ns__insertChip);
	if (!soap_get_conecta4ns__insertChip(soap, &soap_tmp_conecta4ns__insertChip, "conecta4ns:insertChip", NULL))
		return soap->error;
	if (soap_body_end_in(soap)
	 || soap_envelope_end_in(soap)
	 || soap_end_recv(soap))
		return soap->error;
	soap->error = conecta4ns__insertChip(soap, soap_tmp_conecta4ns__insertChip.playerName, soap_tmp_conecta4ns__insertChip.playerMove, soap_tmp_conecta4ns__insertChipResponse.status);
	if (soap->error)
		return soap->error;
	soap->encodingStyle = "";
	soap_serializeheader(soap);
	soap_serialize_conecta4ns__insertChipResponse(soap, &soap_tmp_conecta4ns__insertChipResponse);
	if (soap_begin_count(soap))
		return soap->error;
	if (soap->mode & SOAP_IO_LENGTH)
	{	if (soap_envelope_begin_out(soap)
		 || soap_putheader(soap)
		 || soap_body_begin_out(soap)
		 || soap_put_conecta4ns__insertChipResponse(soap, &soap_tmp_conecta4ns__insertChipResponse, "conecta4ns:insertChipResponse", "")
		 || soap_body_end_out(soap)
		 || soap_envelope_end_out(soap))
			 return soap->error;
	};
